...
<footer className="bg-white dark:bg-gray-900 text-center">
    ...
    <div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        ...
        <label className="label">
            <span className="label-text font-extrabold text-lg">Sign Up for Newsletter Enter your email address</span>
        </label> 
        <div className="relative my-2">
            <input type="text" placeholder="username@site.com" className="form-control input-bordered w-full pr-16" /> 
