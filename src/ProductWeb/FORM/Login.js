...
function Login() {
  ...
  function submit(e) {
    ...
    auth.signInWithEmailAndPassword(loginEmail, loginpassword).then(() => {
      ...
      navigate('/')
      setsignIn('Sign in')
    }).catch((err)=> seterror(err.message),setsignIn('Sign in'))
  }


  return (
    <div className="grid md:grid-cols-2 bg-slate-100 mt-10">
      <div>
  ...
  <div className="max-w-md w-full space-y-8">
    ...
    <form className="mt-8 space-y-6" action="#" method="POST">
      ...
      <h1 className='mt-10'>Don't Have An Acoount? Register <Link className='text-red-400' to='/signup'>here</Link> </h1>
